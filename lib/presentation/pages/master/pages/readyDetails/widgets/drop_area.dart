...
class DropAreaReady extends StatelessWidget {
  const DropAreaReady(this.activeArea, this.listItemArea, {super.key});
  ...
  Widget build(BuildContext context) {
    return Container(
              ...
              child: DropdownButton<int>(
                ...
                onChanged: (value) => value != null ? context.read<CubitReadyDetails>().setActiveArea(value) : null,
              ),
            );
  }
}
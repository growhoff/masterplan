  ...
  Widget build(BuildContext context) {
    return Row(
              ...
              children: [
                ...
                Expanded(child: IconButton(onPressed: (){}, icon: const Icon(Icons.fmd_bad_outlined))),
                Expanded(child: IconButton(onPressed: (){}, icon: const Icon(Icons.mode_edit_outline_rounded))),
              ],
            );
  }
}
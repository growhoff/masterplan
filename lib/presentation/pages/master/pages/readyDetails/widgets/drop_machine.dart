...
class DropMachineReady extends StatelessWidget {
  const DropMachineReady(this.activeMachine, this.listItemMachine, {super.key});
  ...
  Widget build(BuildContext context) {
    return Container(
              ...
              child: DropdownButton<int>(
                ...
                onChanged: (value) => value != null ? context.read<CubitReadyDetails>().setActiveMachine(value) : null,
              ),
            );
  }
}
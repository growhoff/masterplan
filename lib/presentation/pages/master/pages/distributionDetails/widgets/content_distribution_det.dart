                ...
                builder: (context, state) => Visibility(
                  ...
                  child: const Card(
                    ...
                    child: Padding(
                      ...
                      child: Row(
                        children: [
                          Expanded(flex: 1, child: Center(child: RotatedBox(quarterTurns: 3, child: Text('Приоритет', textAlign: TextAlign.center, style: TextStyle(fontSize: 10),)))),
                          Expanded(flex: 4, child: Text('Деталь\nОперация', textAlign: TextAlign.center)),
                          Expanded(flex: 1, child: Text('на\nраспр.,\nшт.', textAlign: TextAlign.center)),
                          Spacer()
                        ],
                      ),
                    ),

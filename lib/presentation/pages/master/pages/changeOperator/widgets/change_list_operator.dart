                            ...
                            builder:(context, state) {
                             ...
                             return Row(
                              ...
                              children: [
                                ...
                                Visibility(visible: (changeItem != null), child: IconButton(onPressed: () => context.read<CubitChangeOperator>().deleteShifts(changeItem!.id), icon: const Icon(Icons.delete)))
                              ],
                            ),
                              ],
                            );

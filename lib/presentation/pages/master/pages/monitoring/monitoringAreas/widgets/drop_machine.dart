...
class DropMachine extends StatelessWidget {
  const DropMachine(this.activeMachine, this.listItemMachine, {super.key});
  ...
  Widget build(BuildContext context) {
    return Container(
              ...
              child: DropdownButton<int>(
                ...
                onChanged: (value) => value != null ? context.read<CubitMonitoringAreas>().setActiveMachine(value) : null,
              ),
            );
  }
}
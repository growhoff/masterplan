...
class StateMonitoringAreas extends Equatable {
  ...
  @override
  List<Object> get props => [isLoading, maxChange, listMonitor ?? [], days, change, activePage, listStatusActiveNew, statusActiveList ?? [], activeArea, activeMachine, listAreaMachine, listItemArea, listItemMachine];

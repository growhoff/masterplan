          ...
          SizedBox(
            ...
            child: ListView.separated(
              ...
              itemBuilder: (context, index) => GestureDetector(
                ...
                child: SizedBox(width: 200, child: Card(color: state.activePage == index ? Colors.blueGrey : const Color.fromARGB(0, 0, 0, 0), child: Center(child: Text(state.listBar![index].machine.name)))),
              ), 

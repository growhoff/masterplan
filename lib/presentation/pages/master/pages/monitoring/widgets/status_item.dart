          ...
          children: [
            Row(
              children: [
                    ...
                    Expanded(flex: 2,child: Text(context.read<CubitMonitoring>().convertTime(item.timeStart))),
                    Expanded(flex: 2,child: Text(context.read<CubitMonitoring>().convertTime(item.timeEnd))),
                    Expanded(flex: 2,child: Text(context.read<CubitMonitoring>().convertTime(item.timeWorking))),

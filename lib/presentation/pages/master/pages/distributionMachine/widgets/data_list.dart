        ...
        for (var stage in itemOper.batch.stageList) {
          for (var operation in stage.operationList) {
            listItem.add(ItemText(
                ...
                detailName: itemOper.batch.name,
                quantity: stage.operationList.length));
          }
        }
      }
    }
    if (listItem.isNotEmpty)
      selected = List<bool>.generate(listItem.length, (int index) => false);
    super.initState();
  }
                    ...
                    Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                              'количество ${listItem[index].operationNumber} / ${listItem[index].quantity}')
                        ],
                      ),
                    ),
                  )

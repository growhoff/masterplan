...
class RowList extends StatelessWidget {
  const RowList({super.key, required this.text1, required this.text2, required this.text3, required this.text4, required this.mod, required this.color});
  final String text1;
  final String text2;
  final String text3;
  final String text4;
  ...
  Widget build(BuildContext context) {
    return Card(
      color: mod != null ? Colors.amberAccent : color,
      child: Padding(

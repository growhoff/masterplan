...
class MonitoringPageChM extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocProvider<CubitMonitoringChM>(
      create: (context) => CubitMonitoringChM(stateMain.machineList,  stateMain.machineIdList!),
...
class MonitoringPageContentChM extends StatelessWidget {
  const MonitoringPageContentChM({super.key});
  @override
  Widget build(BuildContext context) {

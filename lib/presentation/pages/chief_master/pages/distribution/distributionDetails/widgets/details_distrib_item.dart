    ...
    return Card(
      ...
      child: Padding(
        ...
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            BlocBuilder<CubitDistributionDetailsChMas, StateDistributionDetailsChMas>(builder: (context, state) {
              List<String> list = [];
            ...
            Row(
              ...
              children: [
                ...
                Expanded(child: SizedBox(
                  width: 100, 
                  child: TextFormField(
                    onChanged: (value) => context.read<CubitDistributionDetailsChMas>().setCount(index, value),
                )))
              ],
            ),
            const SizedBox(height: 8),
            Row(
              ...
              children: [
                ...
                Expanded(child: SizedBox(
                  width: 100, 
                  child: TextFormField(
                    onChanged: (value) => context.read<CubitDistributionDetailsChMas>().setOptPath(index, value),
                )))
              ],
            )
          ],

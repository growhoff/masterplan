...
import '../model/set_model_chief.dart';
import 'state.dart';
...
class CubitDistributionDetailsChMas extends Cubit<StateDistributionDetailsChMas> {
  ...
  CubitDistributionDetailsChMas(this.areaIdListUser, this.listMachine, this.listAreaMachine) : super(const StateDistributionDetailsChMas()){

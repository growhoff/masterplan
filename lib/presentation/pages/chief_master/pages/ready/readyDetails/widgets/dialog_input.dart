...
class DialogInput extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return AlertDialog(
                ...
                ElevatedButton(
                  onPressed: () {
                    status ? context.read<CubitReadyDetailsChM>().toggleBrak(indexOper, brakController.text, commitController.text) : context.read<CubitReadyDetailsChM>().toggleModific(indexOper, brakController.text, commitController.text);

...
import 'package:master_plan/presentation/pages/chief_master/pages/readyDetails/bloc/cubit.dart';
...
class DialogInput extends StatelessWidget {
  const DialogInput({super.key, required this.indexOper, required this.count, required this.status});
  final int count;
  final int indexOper;
  final bool status;
  @override
  Widget build(BuildContext context) {
    ...
    return AlertDialog(
                ...
                ElevatedButton(
                  onPressed: () {
                    status ? context.read<CubitReadyDetailsChM>().toggleBrak(indexOper, brakController.text) : context.read<CubitReadyDetailsChM>().toggleModific(indexOper, brakController.text);

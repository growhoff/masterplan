...
class DropAreaQueue extends StatelessWidget {
  const DropAreaQueue(this.activeArea, this.listItemArea, {super.key});
  ...
  Widget build(BuildContext context) {
    return Container(
              ...
              child: DropdownButton<int>(
                ...
                onChanged: (value) => value != null ? context.read<CubitQueueMaster>().setActiveArea(value) : null,
              ),
            );
  }
}
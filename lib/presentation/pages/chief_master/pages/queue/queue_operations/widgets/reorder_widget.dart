        ...
        itemBuilder: (context, index) {
          ...
          return Container(
            ...
            children: [
              ...
              Expanded(flex: 3, child: Text(list[index].stageNumber, textAlign: TextAlign.center)),
              ...
              Expanded(child: IconButton(onPressed: () {}, icon: const Icon(Icons.close, color: Colors.red))),
            ],
                  ),
          );
        },

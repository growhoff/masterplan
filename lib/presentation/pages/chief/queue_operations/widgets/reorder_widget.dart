        ...
        itemBuilder: (context, index) {
          ...
          return Container(
            ...
            children: [
              ...
              Expanded(child: IconButton(onPressed: () => context.read<CubitOperatQueueMasterChM>().updateOperationReady(list[index].idPath), icon: const Icon(Icons.check_rounded, color: Colors.green))),
              //передать на распределение
              Expanded(child: IconButton(onPressed: () => context.read<CubitOperatQueueMasterChM>().updateOperationDistribMaster(list[index].idPath), icon: const Icon(Icons.close, color: Colors.red))),
            ],
                  ),
          );
        },

                    ...
                    child: Column(children: [
                      Text(
                          '${chiefDistributionStageModel
                              .stageNumber}, ${chiefDistributionStageModel
                              .stageName}',
                          textAlign: TextAlign.center),
                      Text(
                          '${chiefDistributionStageModel
                              .planNumber}, ${chiefDistributionStageModel
                              .planName}',
                          textAlign: TextAlign.center)
                    ])),
                Expanded(
                    ...
                    child: Text(
                      '${chiefDistributionStageModel
                          .receivedQuantity} / ${chiefDistributionStageModel
                          .waitingQuantity}',
                      textAlign: TextAlign.center,
                    )),
                Expanded(
                    ...
                    child: PriorityCircle(
                      chiefDistributionStageModel.priority, size: 24,))
              ],
            ),
          )),
    );

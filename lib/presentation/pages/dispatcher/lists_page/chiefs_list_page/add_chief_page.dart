...
class AddChiefPageView extends StatefulWidget {
  const AddChiefPageView({super.key});

  @override
  State<AddChiefPageView> createState() => _AddChiefPageViewState();
}

class _AddChiefPageViewState extends State<AddChiefPageView> {
  @override
  void initState() {
    super.initState();

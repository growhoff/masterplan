...
class _DispatcherArchivePageViewState extends State<DispatcherArchivePageView> {
  @override
  void initState() {
    context.read<DispatcherArchiveCubit>().fetchBatches();
    super.initState();
  }

  @override
  Widget build(BuildContext context) {
    return BlocBuilder<DispatcherArchiveCubit, DispatcherArchiveState>(
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                ...
                state.status == DispatcherArchiveStatus.success
                    ? Expanded(

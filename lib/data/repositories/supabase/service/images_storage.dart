...
class ImageStorage extends SupabaseStorage {
  ...
  @override
  Future<void> uploadBinary({required String path, required bytes, required String? imageExtension}) async {
    await _imageStorage.uploadBinary(path, bytes, fileOptions: FileOptions(upsert: true, contentType: imageExtension));
  }

...
class UserDTO2 extends Dto {
  ...
  factory UserDTO2.fromMap(Map<String, dynamic> map) {
    return UserDTO2(
      ...
      company: map['z_company'] != null ? CompanyDTO2.fromMap(map['z_company'] as Map<String, dynamic>) : null,
      unit: map['z_unit'] != null
          ? UnitDTO2.fromMap(map['z_unit'] as Map<String, dynamic>)
          : null,
      area: map['z_area'] != null
          ? AreaDTO2.fromMap(map['z_area'] as Map<String, dynamic>)
          : null,
